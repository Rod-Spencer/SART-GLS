...
Section "SART Internal"
    ...
    File "..\bin\Release\Black Box Web Service Client.dll"
    ...
    File "..\bin\Release\BugZilla Web Service Client.dll"
    ...
    File "..\bin\Release\IDOProtocol.dll"
    ...
    File "..\bin\Release\Manufacturing Web Service Client.dll"
    File "..\bin\Release\MGShared.dll"
    ...
    File "..\bin\Release\Syteline External Web Service Client.dll"
    ...
    File "..\bin\Release\WSEnums.dll"
    File "..\bin\Release\WSFormServerProtocol.dll"
    ...
    File "..\bin\Release\Black Box Web Service Client.pdb"
    ...
    File "..\bin\Release\BugZilla Web Service Client.pdb"
    ...
    File "..\bin\Release\Manufacturing Web Service Client.pdb"
    ...
    File "..\bin\Release\Syteline External Web Service Client.pdb"
    ...
    Delete "$INSTDIR\App Data\Developer Defaults.xml"
