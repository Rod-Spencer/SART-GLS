...
{
    public class Return_ViewModel : ViewModelBase, Return_ViewModel_Interface, INavigationAware
    {
        ...
        public Return_ViewModel(Return_Control_Interface view, IRegionManager regionManager, IUnityContainer container, IEventAggregator eventAggregator)
            : base(view)
        {
