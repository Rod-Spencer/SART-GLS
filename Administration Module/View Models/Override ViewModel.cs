...
{
    public class Override_ViewModel : ViewModelBase, Override_ViewModel_Interface, INavigationAware
    {
        ...
        public Override_ViewModel(Override_Control_Interface view, IRegionManager regionManager, IUnityContainer container, IEventAggregator eventAggregator)
            : base(view)
        {
