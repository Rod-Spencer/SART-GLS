...
{
    public class Parts_Management_ViewModel : ViewModelBase, Parts_Management_ViewModel_Interface, INavigationAware
    {
        ...
        public Parts_Management_ViewModel(Parts_Management_Control_Interface view, IRegionManager regionManager, IUnityContainer container, IEventAggregator eventAggregator)
            : base(view)
        {
