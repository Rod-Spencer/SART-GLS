...
namespace Segway.Modules.SART.CodeLoad
{
    ...
    {
        /// <summary>Public Method - PostBSALoad</summary>
        /// <param name="side">CAN_CU_Sides</param>
        /// <param name="obj">SART_Event_Object</param>
        /// <param name="status">Boolean</param>
        /// <returns>Boolean</returns>
        public Boolean PostBSALoad(CAN_CU_Sides side, SART_Event_Object obj, Boolean status)
        {
            try
            {
                ...
                SART_Common.Create_Event(WorkOrder_Events.Loaded_BSAA_Code + (side - CAN_CU_Sides.A), status ? Event_Statuses.Passed : Event_Statuses.Failed, obj.ID);
